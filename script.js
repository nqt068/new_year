...
(function() {
    var animation = {
      ...
      get period() {
        ...
        var hours_ = Math.floor(minutes/60);
        var hours = Math.floor(minutes/60);
        var days = 0;
        hours = hours-(Math.floor(hours_/24)*24);
        minutes = minutes-(Math.floor(hours_/24)*24*60)-(hours*60);
        seconds = seconds-(Math.floor(hours_/24)*24*60*60)-(hours*60*60)-(minutes*60);
        return {
